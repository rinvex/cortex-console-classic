let OutputFormatter = require('./output-formatter');
let Loading = require('./loading');
let Artisan = require('./commands/artisan');
let Composer = require('./commands/composer');
let Default = require('./commands/default');
...
Interactive commands does \`${this.comment('NOT')}\` work through web.`;
    }
    ...
    serverInfo() {
        ...
        const host = `${this.info(this.options.username)}${this.info(
            '@'
        )}${this.info(this.options.hostname)}`;
