...
Breadcrumbs::for('adminarea.cortex.console.terminal.index', function (Generator $breadcrumbs) {
    $breadcrumbs->push('<i class="fa fa-dashboard"></i> '.config('app.name'), route('adminarea.home'));
    $breadcrumbs->push(trans('cortex/console::common.terminal'), route('adminarea.cortex.console.terminal.index'));
});

Breadcrumbs::for('adminarea.cortex.console.routes.index', function (Generator $breadcrumbs) {
    $breadcrumbs->push('<i class="fa fa-dashboard"></i> '.config('app.name'), route('adminarea.home'));
